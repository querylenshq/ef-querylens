...
internal static class MySqlAppConnectionStrings
{
    private const string RuntimeConnectionName = "SampleMySql";
    private const string OfflineConnectionName = "SampleMySqlQueryLensOffline";
    private const string RuntimeEnvironmentVariable = "SAMPLE_MYSQL_CONNECTION_STRING";
    private const string OfflineEnvironmentVariable = "SAMPLE_MYSQL_QUERYLENS_CONNECTION_STRING";
    ...
    {
        var assemblyDirectory = Path.GetDirectoryName(typeof(MySqlAppConnectionStrings).Assembly.Location)
