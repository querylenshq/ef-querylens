...
public sealed partial class QueryEvaluator
{
    ...
    private static void AppendCapturedTypes(StringBuilder sb)
    {
        sb.AppendLine();
    ...
    private static void AppendOfflineDbConnection(StringBuilder sb)
    {
        sb.AppendLine();
    ...
    private static void AppendFakeDbDataReader(StringBuilder sb)
    {
        sb.AppendLine();
    ...
    private static void AppendSqlCaptureScope(StringBuilder sb)
    {
        sb.AppendLine();
    ...
    private static void AppendOfflineCapture(StringBuilder sb)
    {
        sb.AppendLine();
